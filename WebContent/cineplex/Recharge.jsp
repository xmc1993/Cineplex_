...
<head>
  ...
  <jsp:useBean id="account" type="xmc.cineplex.model.Account" scope="session"></jsp:useBean>
   ...
   <div>
	...
	<p></p>
	<form role="form" action="recharge.action" method="post">
		<legend><strong>会员卡充值</strong></legend>
		<div class="well-sm well">
		<p><label>绑定的银行卡号：</label><jsp:getProperty name="account" property="bankAccount"/></p>
		</div>
		<div class="form-group">
		<label>输入充值金额：</label>
		<input type="text" class="form-control" name="amount" placeholder="sum"/>
		</div>
		<div class="form-group">
		<label>输入银行卡密码：</label>
