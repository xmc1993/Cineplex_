...
<!--body-->
  <body style="background-color:#000000">
   ...
   <div>
	...
	<p></p>
	<form role="form" method="post" action="downFilm.action">
		<legend><strong>下线电影</strong></legend>
		<div class="form-group">
		<label>请输入电影名称：</label>
		<input type="text" class="form-control" name="uid" placeholder="Film name"/>
		</div>
		<button class="btn-block btn-lg btn-danger" type="submit">确认</button>
	</form>
		<p></p>
		<br/>
	</div>
